...
Z.h.ga=["google"],function(){var a,b;(function(c){Z.__ga=c;Z.__ga.i="ga";Z.__ga.m=!0;Z.__ga.priorityOverride=0})(function(c){function d(R){var L=[].slice.call(arguments,0);L[0]=u+L[0];t.push(L)}function e(R,L){void 0!==c[L]&&d(R,c[L])}function f(R,L){void 0!==c[L]&&d(R,Number(c[L]))}function g(R,L){if(q(L))for(var X=0;X<L.length;X++)d(R,L[X])}function h(R,L,X){if(q(L))for(var fa=0;fa<L.length;fa++){for(var va=[R],Q=L[fa],Ga=0;Ga<
X.length;Ga++)va.push(Q[X[Ga]]);d.apply(this,va)}}function l(R,L){void 0!==c[L]&&d("_set",R,c[L])}function m(R,L){return void 0===L?L:R(L)}function n(R,L){void 0!==L&&(v+="&"+R+"="+L)}var q=Ra,t=V("_gaq",[],!1),r=!1,u="";void 0==c.vtp_trackerName?u="gtm"+Lh()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",fm(!0));
e("_setAllowLinker","vtp_allowLinker");
e("_setAllowAnchor","vtp_allowAnchor");e("_setAllowHash","vtp_allowHash");
g("_addIgnoredRef",c.vtp_ignoredRef);g("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var w=function(R,L,X){for(var fa=L.length-1;0<=fa;fa--){var va=L[fa].split("=");if(va[0]===R)return va[1]||"1"}for(var Q=X.length-1;0<=Q;Q--){var Ga=X[Q].split("=");if(Ga[0]===R)return Ga[1]||"1"}},y=ch(sr()),x=ah(y,"query").split("&"),z=c.vtp_allowAnchor?ah(y,"fragment").split("&"):[];n("gclid",w("gclid",z,x));n("gclsrc",w("gclsrc",z,x));n("dclid",w("dclid",z,x));d("_set",
...
r=!!c.vtp_forceSsl);d("_set","hitCallback",function(){Na(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});
...
g("_cookiePathCopy",c.vtp_cookiePathCopy);var aa=function(){V("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,T(Wj("https","http","://stats.g.doubleclick.net/dc.js",r),aa,c.vtp_gtmOnFailure));else if(!a){var sa=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;T(Wj("https://ssl","http://www",sa,r),aa,c.vtp_gtmOnFailure)}})}();
